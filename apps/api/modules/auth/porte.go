...
// NewUserStore returns the user store backed by the given database.
...
// claim asserts nothing: a provider that stops sending a name is not allowed
// to blank the stored one.
