...
var Documentation = documentation.Module{
	...
	Routes: []documentation.Route{
		...
		{Method: "POST", Path: "/time-entries/pause", Summary: "Pause running timer", Auth: "bearer token required"},
		{Method: "POST", Path: "/time-entries/resume", Summary: "Resume paused timer", Auth: "bearer token required"},
