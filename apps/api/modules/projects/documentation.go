...
var Documentation = documentation.Module{
	...
	Routes: []documentation.Route{
		...
		{Method: "PUT", Path: "/projects/{id}/tasks/{taskId}", Summary: "Update project task", Auth: "bearer token required"},
		{Method: "DELETE", Path: "/projects/{id}/tasks/{taskId}", Summary: "Delete project task", Auth: "bearer token required"},
	},
}
