import { p as ssr_context, h as head, d as escape_html, j as sanitize_props, k as spread_props, m as attributes, n as clsx, o as bind_props, l as slot, q as ensure_array_like, r as derived, t as hasContext, f as getContext, w as setContext, x as element, y as props_id, z as getAllContexts, A as lifecycle_function_unavailable } from './index2-BK72vU4V.js';
import { g as goto } from './client-cHGcHw9I.js';
import { B as Button, c as cn, s as styleToString, a as createBitsAttrs, t as tv, b as boxWith, d as simpleBox, e as boolToTrueOrUndef, m as mergeProps, i as isObject, f as createId, g as attachRef, h as boolToEmptyStrOrUndef, j as getDataOpenClosed, k as boolToStr, l as getDataTransitionAttrs, n as boxFrom, o as boolToStrTrueOrUndef, p as cssToStyleObj, q as executeCallbacks, r as composeHandlers } from './create-id-C41XNBK8.js';
import { C as Card, a as Card_header, I as Icon$1, c as Card_title, b as Clock, S as Separator } from './separator-B8l1JNYV.js';
import { L as Label, I as Input } from './label-Bwk0JVVZ.js';
import { o as on } from './root-C01qvPdc.js';
...
const backend = {
  ...
  listEntries(token, projectId) {
    const qs = projectId ? `?project_id=${projectId}` : "";
    return apiFetch(`/time-entries${qs}`, {}, token);
  },
  getRunning(token) {
    return apiFetch("/time-entries/running", {}, token);
  },
  startTimer(token, projectId, description) {
    return apiFetch("/time-entries/start", {
      method: "POST",
      body: JSON.stringify({ project_id: projectId, description })
    }, token);
  },
  stopTimer(token) {
    return apiFetch("/time-entries/stop", { method: "POST" }, token);
  },
  deleteEntry(token, id) {
    return apiFetch(`/time-entries/${id}`, { method: "DELETE" }, token);
  }
};
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function entryDuration(entry) {
      const end = entry.stopped_at ? new Date(entry.stopped_at) : /* @__PURE__ */ new Date();
    ...
    function todayTotal() {
      ...
      for (const e of entries) {
        ...
        const end = e.stopped_at ? new Date(e.stopped_at) : /* @__PURE__ */ new Date();
    ...
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      head("x1i5gj", $$renderer3, ($$renderer4) => {
        $$renderer4.title(($$renderer5) => {
          $$renderer5.push(`<title>Dashboard — Sablier</title>`);
        });
      });
      $$renderer3.push(`<div class="min-h-screen bg-background text-foreground"><header class="border-b border-border"><div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4"><span class="text-lg font-semibold tracking-tight">Sablier</span> <div class="flex items-center gap-4"><span class="hidden text-sm text-muted-foreground sm:block">${escape_html(userEmail)}</span> `);
      Button($$renderer3, {
        variant: "ghost",
        size: "sm",
        onclick: logout,
        children: ($$renderer4) => {
          Log_out($$renderer4, { class: "mr-1.5 size-4" });
          $$renderer4.push(`<!----> Log out`);
        },
        $$slots: { default: true }
      });
      $$renderer3.push(`<!----></div></div></header> <main class="mx-auto max-w-6xl px-6 py-8">`);
      if (error) {
        $$renderer3.push("<!--[0-->");
        $$renderer3.push(`<div class="mb-6 rounded-md border border-border bg-muted px-4 py-3 text-sm text-foreground">${escape_html(error)}</div>`);
      } else {
        $$renderer3.push("<!--[-1-->");
      }
      $$renderer3.push(`<!--]--> <div class="grid gap-6 lg:grid-cols-[1fr_320px]"><div class="space-y-6">`);
      if (Card) {
        $$renderer3.push("<!--[-->");
        Card($$renderer3, {
                ...
                children: ($$renderer5) => {
                  ...
                  if (Card_title) {
                    ...
                    Card_title($$renderer5, {
                      ...
                      children: ($$renderer6) => {
                        Clock($$renderer6, { class: "size-4" });
                        $$renderer6.push(`<!----> ${escape_html(running ? "Timer running" : "Start timer")}`);
                      },
                      $$slots: { default: true }
                    });
                    $$renderer5.push("<!--]-->");
                  ...
                  if (running) {
                    ...
                    Badge($$renderer5, {
                      ...
                      children: ($$renderer6) => {
                        $$renderer6.push(`<!---->${escape_html(elapsed)}`);
                      },
                      $$slots: { default: true }
                    });
                  } else {
            ...
            if (Card_content) {
              ...
              Card_content($$renderer4, {
                children: ($$renderer5) => {
                  if (running) {
                    $$renderer5.push("<!--[0-->");
                    $$renderer5.push(`<div class="space-y-3"><div class="text-sm text-muted-foreground"><span class="font-medium text-foreground">${escape_html(projectName(running.project_id))}</span> `);
                    if (running.description) {
                      $$renderer5.push("<!--[0-->");
                      $$renderer5.push(`— ${escape_html(running.description)}`);
                    } else {
                      $$renderer5.push("<!--[-1-->");
                    }
                    $$renderer5.push(`<!--]--></div> `);
                    Button($$renderer5, {
                      ...
                      onclick: stopTimer,
                      children: ($$renderer6) => {
                        Square($$renderer6, { class: "mr-2 size-4" });
                        $$renderer6.push(`<!----> Stop`);
                      },
                      $$slots: { default: true }
                    });
                    ...
                    $$renderer5.push("<!--[-1-->");
                    $$renderer5.push(`<div class="space-y-4"><div class="grid gap-2">`);
                    Label($$renderer5, {
                      children: ($$renderer6) => {
                    ...
                    if (Select) {
                      ...
                      Select($$renderer5, {
                        type: "single",
                        onValueChange: (v) => timerProjectId = v ? Number(v) : null,
                        children: ($$renderer6) => {
                          if (Select_trigger) {
                            $$renderer6.push("<!--[-->");
                            Select_trigger($$renderer6, {
                              class: "w-full",
                              children: ($$renderer7) => {
                                $$renderer7.push(`<!---->${escape_html(timerProjectId ? projectName(timerProjectId) : "Select project…")}`);
                              },
                              $$slots: { default: true }
                            });
                            $$renderer6.push("<!--]-->");
                            ...
                            Select_content($$renderer6, {
                              children: ($$renderer7) => {
                                ...
                                for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
                                  ...
                                  if (Select_item) {
                                    ...
                                    Select_item($$renderer7, {
                                      ...
                                      children: ($$renderer8) => {
                                        $$renderer8.push(`<!---->${escape_html(project.name)}`);
                                      },
                                      $$slots: { default: true }
                                    });
                                    $$renderer7.push("<!--]-->");
                                ...
                                if (projects.length === 0) {
                                  $$renderer7.push("<!--[0-->");
                                  $$renderer7.push(`<div class="px-3 py-2 text-sm text-muted-foreground">No projects yet</div>`);
                                } else {
                                  $$renderer7.push("<!--[-1-->");
                                }
                                $$renderer7.push(`<!--]-->`);
                    ...
                    Button($$renderer5, {
                      ...
                      children: ($$renderer6) => {
                        Play($$renderer6, { class: "mr-2 size-4" });
            ...
            if (Card_header) {
              ...
              Card_header($$renderer4, {
                children: ($$renderer5) => {
                  ...
                  $$renderer5.push(` <span class="text-sm text-muted-foreground">Today: ${escape_html(todayTotal())}</span></div>`);
                },
                $$slots: { default: true }
              });
              $$renderer4.push("<!--]-->");
            ...
            if (Card_content) {
              ...
              Card_content($$renderer4, {
                ...
                children: ($$renderer5) => {
                  if (entries.length === 0) {
                    $$renderer5.push("<!--[0-->");
                    $$renderer5.push(`<p class="px-6 py-8 text-center text-sm text-muted-foreground">No entries yet.</p>`);
                  } else {
                    $$renderer5.push("<!--[-1-->");
                    if (Table) {
                      $$renderer5.push("<!--[-->");
                                ...
                                if (Table_row) {
                                  ...
                                  Table_row($$renderer7, {
                                    children: ($$renderer8) => {
                                      ...
                                      if (Table_head) {
                                        $$renderer8.push("<!--[-->");
                                        Table_head($$renderer8, { class: "w-10" });
                                        $$renderer8.push("<!--]-->");
                                      } else {
                                        $$renderer8.push("<!--[!-->");
                                        $$renderer8.push("<!--]-->");
                                      ...
                                      children: ($$renderer8) => {
                                        if (Table_cell) {
                                          ...
                                          Table_cell($$renderer8, {
                                            class: "font-medium",
                                            children: ($$renderer9) => {
                                              $$renderer9.push(`<!---->${escape_html(projectName(entry.project_id))}`);
                                            },
                                            $$slots: { default: true }
                                          });
                                          $$renderer8.push("<!--]-->");
                                        ...
                                        if (Table_cell) {
                                          ...
                                          Table_cell($$renderer8, {
                                            ...
                                            children: ($$renderer9) => {
                                              $$renderer9.push(`<!---->${escape_html(entry.description || "—")}`);
                                            },
                                            $$slots: { default: true }
                                          });
                                          $$renderer8.push("<!--]-->");
                                        ...
                                        if (Table_cell) {
                                          ...
                                          Table_cell($$renderer8, {
                                            ...
                                            children: ($$renderer9) => {
                                              $$renderer9.push(`<!---->${escape_html(formatDate(entry.started_at))}`);
                                            },
                                            $$slots: { default: true }
                                          });
                                          $$renderer8.push("<!--]-->");
                                            ...
                                            children: ($$renderer9) => {
                                              if (!entry.stopped_at) {
                                                ...
                                                Badge($$renderer9, {
                                                  ...
                                                  class: "font-mono",
                                                  children: ($$renderer10) => {
                                                    $$renderer10.push(`<!---->${escape_html(elapsed)}`);
                                                  },
                                                  $$slots: { default: true }
                                                });
                                              } else {
                                                $$renderer9.push("<!--[-1-->");
                                                $$renderer9.push(`${escape_html(entryDuration(entry))}`);
                                              }
                                              $$renderer9.push(`<!--]-->`);
                                            },
                                            $$slots: { default: true }
                                          ...
                                          Table_cell($$renderer8, {
                                            children: ($$renderer9) => {
                                              Button($$renderer9, {
                                                ...
                                                children: ($$renderer10) => {
                                                  Trash_2($$renderer10, { class: "size-3.5" });
                                                },
                                                $$slots: { default: true }
                                              });
                                            },
            ...
            if (Card_content) {
              ...
              Card_content($$renderer4, {
                ...
                children: ($$renderer5) => {
                  if (showNewProject) {
                    $$renderer5.push("<!--[0-->");
                    $$renderer5.push(`<div class="space-y-3 rounded-md border border-border p-3"><div class="grid gap-1.5">`);
                    Label($$renderer5, {
                      for: "proj-name",
                      children: ($$renderer6) => {
                        $$renderer6.push(`<!---->Name`);
                    ...
                    $$renderer5.push(`<!----></div> <div class="grid gap-1.5">`);
                    Label($$renderer5, {
                      for: "proj-desc",
                      children: ($$renderer6) => {
                        $$renderer6.push(`<!---->Description`);
                  ...
                  if (projects.length === 0) {
                    $$renderer5.push("<!--[0-->");
                    $$renderer5.push(`<p class="py-4 text-center text-sm text-muted-foreground">No projects yet.</p>`);
                  } else {
                    $$renderer5.push("<!--[-1-->");
                    $$renderer5.push(`<!--[-->`);
                    ...
                    for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
                      ...
                      $$renderer5.push(`<div class="flex items-center justify-between rounded-md px-2 py-2 hover:bg-muted"><div><p class="text-sm font-medium">${escape_html(project.name)}</p> `);
                      if (project.description) {
                        $$renderer5.push("<!--[0-->");
                        $$renderer5.push(`<p class="text-xs text-muted-foreground">${escape_html(project.description)}</p>`);
                      } else {
                        $$renderer5.push("<!--[-1-->");
                      }
                      $$renderer5.push(`<!--]--></div> `);
                      Button($$renderer5, {
                        ...
                        children: ($$renderer6) => {
                          Trash_2($$renderer6, { class: "size-3.5" });
                        },
                        $$slots: { default: true }
                      });
                      $$renderer5.push(`<!----></div>`);
...
//# sourceMappingURL=_page.svelte-C2T7C5WS.js.map
